...
import (
	...
	svcclient "github.com/MuxiKeStack/be-course/service/client"
...
func InitCCNUClient(etcdClient *etcdv3.Client) ccnuv1.CCNUServiceClient {
	...
	retryCCNUClient := svcclient.NewRetryCCNUClient(ccnuClient, cfg.RetryCnt)
